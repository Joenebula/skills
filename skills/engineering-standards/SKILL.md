...
Cross-references: [[design-system]], [[regression-testing]], [[ask-dont-guess]], [[shipping]]. Deeper dives on the concerns this skill touches: [[code-review]] (the review pass), [[security]] (the full trust model behind the gating section), [[data-modelling]] (entities + safe migrations behind the data stages), [[api-design]] (the contract shape), and [[observability]] (what happens when a stage's wiring fails).
